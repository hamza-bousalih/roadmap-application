...
export default function Home() {
    ...
    const handleSignUpSubmit = async (e) => {
        ...
        try {
            const formData = {
                fullname , email , password , phoneNumber , conPassword ,
        ...
        <div className="flex flex-col md:flex-row items-center justify-center px-10 mx-auto max-w-7xl">
            <div className="md:mr-4 md:w-1/2">
                ...
                <p className="text-white paragraphe">
                    ...
                    choisir en fonction de vos besoins spécifiques. Chaque roadmap propose une série d'actions à
                    entreprendre.
                    À l'intérieur de chaque action, vous découvrirez une liste de tâches spécifiques à accomplir. Le
                    processus
                    global vise à vous guider de manière structurée et progressive dans l'accomplissement de vos
                    objectifs,
                    en décomposant le parcours en actions claires et mesurables, puis en détaillant ces actions en
                    tâches
                ...
                <div className="py-6 px-6 lg:px-8 text-left">
                    ...
                    <form className="space-y-6" onSubmit={handleLoginSubmit}>
                        ...
                        <div>
                            ...
                            <input type="password" name="password" id="password" className="data"
                ...
                <div className="py-6 px-6 lg:px-8 text-left">
                    ...
                    <form className="space-y-6" onSubmit={handleSignUpSubmit}>
                        ...
                        <div>
                            ...
                            <input
                                type="password" name="password" id="password" className="data"
                                placeholder="........."
                        ...
                        <div>
                            ...
                            <input
                                type="password" name="conPassword" id="conPassword" className="data"
                                placeholder="........."
